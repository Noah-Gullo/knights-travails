...
test("Shortest path for more than 1 jump", () => {
    expect(knightMoves(new Coordinate(0,0,null), new Coordinate(3,3,null))).toStrictEqual([[0,0], [1,2], [3,3]]);
    expect(knightMoves(new Coordinate(3,3,null), new Coordinate(0,0,null))).toStrictEqual([[3,3], [2,1], [0,0]]);
})